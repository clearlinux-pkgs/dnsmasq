...
Source0  : https://www.thekelleys.org.uk/dnsmasq/dnsmasq-2.91.tar.xz
Source1  : dnsmasq.service
Source2  : dnsmasq.tmpfiles
Source3  : https://www.thekelleys.org.uk/dnsmasq/dnsmasq-2.91.tar.xz.asc
...
%setup -q -n dnsmasq-2.91
cd %{_builddir}/dnsmasq-2.91
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748458314
